      ...
      child: Row(
        ...
        children: [
          _buildSummaryItem(
            context,
            'Total dist.',
            _statistics!.totalDistance,
            Icons.straighten_rounded,
          ),
          _buildSummaryItem(
            context,
            'Promedio',
            _statistics!.averageDistance,
            Icons.analytics_rounded,
          ),
          _buildSummaryItem(
            context,
            'Objetivo',
            _statistics!.distanceGoal,
            Icons.flag_rounded,
          ),
        ],
      ),
    ...
    return BarChart(
      BarChartData(
        ...
        barGroups: points
            .asMap()
            .entries
            .map((e) => _makeBarGroup(context, e.key, e.value.value))
            .toList(),
      ),
    );
  }
